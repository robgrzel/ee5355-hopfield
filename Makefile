...
CUFILES	    := evaluate_dense.cu evaluate_dense_bit.cu evaluate_dense_block.cu evaluate_dense_coarse.cu evaluate_dense_cutoff.cu evaluate_sparse.cu evaluate_sparse_warp.cu evaluate_sparse_queue.cu
